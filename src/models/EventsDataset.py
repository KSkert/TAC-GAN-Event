...
class EventDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        res = {'embeddings': self.get_embeddings_vec(events_cur_date, 'embedding'), 'date': pd.to_datetime(date).normalize()} # added date here, is this update enough?
...
class EventsDataModule(pl.LightningDataModule):
    ...
    def collate_fn(self, batch):
        ...
        batch_dict['date'] = [t['date'] for t in batch]
